...
MyCollectionPane.prototype.setVisibleCollection = function (collection, value) { // function Hide collection
...
MyCollectionPane.prototype.getCollectionIcon = function (collection) {
    return collection.icon || MyCollectionPane.ICON_MAP[collection.id] || "border_all";
};
MyCollectionPane.prototype.onSizeChanged = function () {
    if (!this.loaded) {
        setTimeout(this.reload.bind(this), 300);
    }
};
MyCollectionPane.prototype.reload = function (selectedCollectionId) {
    console.log("my collections: ", PrivateCollectionManager.privateShapeDef.collections);
...
MyCollectionPane.prototype.filterCollections = function () {
...
MyCollectionPane.prototype.ensureSelectedCollectionVisible = function (collection) {
